import sys          # built in sys module, giving us a list of string arguements with list.argv
import requests
...
High of {temp_c_high:.1f} °C ({c_to_f(temp_c_high):.1f} °F)
Low of {temp_c_low:.1f} °C ({c_to_f(temp_c_low):.1f} °F)
